...
Blank sections are due to me not being able to find information on the feature
...
As mencioned before, this isn't supposed to be a full tutorial, but the steps I've taken to setup up umami
...
```
3000 is the default port for yarn, but adjust for your needs
...
Creating a user specific to this service, along with setting correct network permissions, would be the safest, but you can figure that out
...
Before you go any further, follow the official documentation, then come back :3
